...
const zhCN: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "你希望 My_ZCode 如何呈现工作过程？",
  ...
  "occupationOnboarding.description": "选择最接近你日常工作的一项，让 My_ZCode 更懂你的工作。",
  ...
  "occupationOnboarding.memoryDescription": "让 My_ZCode 记住你的偏好与工作上下文。",
  ...
  "startup.global.silent": "正在启动 My_ZCode",
  ...
  "startup.global.servicesFailed":
    "本地数据准备已完成，但应用服务启动失败。请复制诊断信息，退出并重新打开 My_ZCode。",
  ...
  "startup.global.starting_services": "正在启动 My_ZCode",
  "startup.global.ready": "本地数据已就绪",
  "startup.global.failed": "无法完成启动准备",
  "startup.global.help":
    "准备完成后将自动进入 My_ZCode。历史记录较多时可能需要较长时间，请保持应用运行。",
  ...
  "settings.computerUse.disabledToast": "电脑控制已关闭，已有对话需重启 My_ZCode 后生效。",
  ...
  "login.title": "欢迎来到 My_ZCode",
  "login.description": "连接账号，开始使用 My_ZCode",
  ...
  "app.login": "连接使用",
  "app.logout": "断开连接",
  "logout.confirm.title": "断开连接并重启 My_ZCode？",
  ...
  "modelTrajectory.empty": "暂无模型调用记录（仅 My_ZCode Agent 会落盘 model-io）",
  ...
  "titleBar.menu.help.about": "关于 My_ZCode",
  ...
  "titleBar.menu.help.toggleMy_ZCodeStdioTap": "抓取 Agent stdio 通信",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "工作区目录不存在或无法访问，当前仅可查看历史记录。恢复该目录后重启 My_ZCode 即可继续使用。",
  ...
  "ssh.assetInstallModeDescription":
    "远端服务器下载可减少上传等待，但服务器需要能访问 My_ZCode CDN，并具备下载、解压和校验工具。",
  "ssh.password": "密码",
  ...
  "settings.terminalFontFamilyDescription":
    "留空时自动探测系统终端配置；填写后作为 My_ZCode 终端的字体覆盖。",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "在 My_ZCode 运行时将后续操作加入队列，或引导至下一轮工具调用后运行。",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "不能选择 My_ZCode 安装目录作为数据存储路径。请选择安装目录之外的文件夹。",
  ...
  "settings.migration.sectionDescription":
    "扫描本机 Claude Code 原生历史，可按 workspace 和时间范围筛选，再把选中的会话导入到对应的 My_ZCode 任务列表。",
  ...
  "resourceManager.storage.summaryTotal": "My_ZCode 总占用",
  ...
  "resourceManager.storage.diskUsage": "My_ZCode 占用 {used}",
  ...
  "settings.browser.desktopOnly": "浏览器数据只能在 My_ZCode 桌面端管理。",
  ...
  "settings.browser.import.helperVerificationFailed":
    "My_ZCode 的 Windows 安全导入组件校验失败，Cookie 未导入。请重新安装或更新 My_ZCode。",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome 在 Windows 上使用 App-Bound 加密保护 Cookie。My_ZCode 将为本次导入请求管理员权限，临时启动系统服务，完成后立即删除。不会读取或导入 Chrome 密码。",
  ...
  "settings.mcp.description": "管理 My_ZCode Agent 使用的 MCP 服务器配置。",
  ...
  "settings.mcp.host.activeDescription":
    "该 MCP 服务器由 My_ZCode 宿主为 {pluginName} 插件提供，运行时身份由宿主管理。",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "当前 My_ZCode Agent 不支持 OAuth 状态刷新。请升级或重启 My_ZCode，然后重新打开 MCP 设置进行完整刷新。",
  ...
  "settings.mcp.failure.not_authenticated": "当前未登录，请先登录 My_ZCode。",
  ...
  "settings.mcpServers.import.importing": "正在导入 MCP 服务器到 My_ZCode",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description": "登录 My_ZCode 3.x 后开始计时。",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "支持 BYOK、BYOA；Base URL、API Format 和 API Key 由 My_ZCode 自动维护，无需手动配置。",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "请先在 BigModel 团队套餐管理页添加自己或其他成员，完成后即可在 My_ZCode 使用团队额度。",
  ...
  "settings.modelProvider.help.contextWindow":
    "模型一次可处理的上下文容量，单位为 Token。My_ZCode 会据此管理上下文。\n请勿超过模型的实际上限。",
  ...
  "settings.modelProvider.help.followRecommendedConfig":
    "根据模型 ID、Base URL 和 API 格式，为您智能匹配推荐配置。My_ZCode 会持续更新推荐配置，并自动同步给您。\n如果手动修改某项配置，该项将转为手动管理，不再跟随推荐更新；其他配置仍由智能配置管理。",
  ...
  "settings.usage.billingBanner.description":
    "连接 {provider} 账号后查询编程套餐权益，购买或配置后回到 My_ZCode 即可继续编码。",
  ...
  "sidebar.usage.plan.zcodeMcpDescription": "My_ZCode 预置插件 MCP 每日合计额度",
  ...
  "settings.skills.import.mode.copy.description":
    "将完整技能目录复制到 My_ZCode。外部 Agent 目录后续变更不会自动同步。",
  "settings.skills.import.mode.symlink.description":
    "创建指向外部 Agent 技能目录的链接。My_ZCode 会跟随来源目录后续变更，但该技能依赖来源路径持续可用。",
  "settings.skills.import.importing": "正在导入技能到 My_ZCode",
  ...
  "settings.subagents.description": "管理 My_ZCode Agent 运行时消费的用户级子智能体 Markdown 文件。",
  ...
  "settings.plugins.store.subtitle": "用插件为 My_ZCode 扩展技能、命令与 MCP 能力",
  ...
  "settings.plugins.import.mode.copy.description":
    "将完整插件目录复制到 My_ZCode，并注册到 plugins.dirs。外部 Agent 目录后续变更不会自动同步。",
  "settings.plugins.import.mode.symlink.description":
    "创建指向外部 Agent 插件目录的链接，并注册到 plugins.dirs。My_ZCode 会跟随来源目录后续变更，但该插件依赖来源路径持续可用。",
  "settings.plugins.import.importing": "正在导入插件到 My_ZCode",
  ...
  "settings.commands.description":
    "管理 My_ZCode Agent 的 .md 命令文件。命令可通过 /command-name 在聊天中调用。",
  ...
  "settings.commands.import.mode.copy.description":
    "将命令文件复制到 My_ZCode。外部 Agent 文件后续变更不会自动同步。",
  "settings.commands.import.mode.symlink.description":
    "创建指向外部 Agent 命令文件的链接。My_ZCode 会跟随来源文件后续变更，但该命令依赖来源路径持续可用。",
  "settings.commands.import.importing": "正在导入命令到 My_ZCode",
  ...
  "settingsSync.discovery.helper": "仅导入缺失项，不会覆盖当前 My_ZCode 中已存在的配置。",
  ...
  "onboarding.dialog.title": "欢迎使用 My_ZCode",
  "onboarding.dialog.description": "选择如何开始第一次会话。",
  "onboarding.wizard.label": "迁移向导",
  "onboarding.welcome.eyebrow": "首次启动设置",
  "onboarding.welcome.title": "欢迎使用 My_ZCode",
  "onboarding.welcome.start": "开始使用 My_ZCode",
  ...
  "onboarding.stepDescription.migration": "开始迁移并等待 My_ZCode 完成导入。",
  ...
  "onboarding.agentsFile.confirmDescription":
    "将从 {source} 复制到 {target}。\n如果目标文件已存在，My_ZCode 默认 AGENTS 配置会被覆盖。",
  ...
  "chat.placeholder.newTask": "向 My_ZCode 提问，使用 @ 添加上下文，使用 / 选择命令或能力",
  "chat.placeholder.newTaskMobile": "向 My_ZCode 提问…",
  ...
  "chat.toolbar.computerUse.tooltip.ready": "电脑操作已就绪 · 直接描述你想让 My_ZCode 做的事",
  "chat.toolbar.computerUse.tooltip.permissionRequired": "缺少 macOS 权限，点击完成授权",
  "chat.toolbar.computerUse.tooltip.error":
    "电脑操作启用失败 · 重启 My_ZCode 应用后重试，或让 My_ZCode 排查日志",
  ...
  "workflows.hub.empty.hint":
    "在对话里让 My_ZCode 设计工作流，跑通之后再让它保存到项目里。未打开的项目不会出现在这里。",
  ...
  "workflows.hub.detail.whenToUse.help": "给 My_ZCode 的路由提示：什么场景该选这个工作流。",
  ...
  "workflows.hub.detail.script.note": "脚本只读。要改脚本，在对话里让 My_ZCode 修订后另存一版。",
  ...
  "chat.quota.mcp.quotaExhausted": "My_ZCode MCP「{server}」今日额度已用完，明天自动恢复。",
  "chat.quota.mcp.codingPlanRequired":
    "当前无 My_ZCode MCP「{server}」额度，请登录或开通 Coding Plan 使用。",
  ...
  "feedback.submit.template.section.copyErrorHeading": "My_ZCode 报错信息",
  // 表单通用
  ...
  "offPeak.keepAwakeBanner": "My_ZCode 运行会话时保持电脑唤醒。",
  ...
  "offPeak.form.instructionsPlaceholder":
    "描述希望 My_ZCode 在后台完成的工作、预期结果和约束，例如整理本周代码改动并生成站会摘要…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "My_ZCode 电脑控制仍在准备中——工具尚未加载（已加载 {count} 个）。请先授予下方权限，Helper 就绪后工具会自动出现。",
  "chat.cuaReadiness.toolsPreparing":
    "My_ZCode 电脑控制仍在准备中——工具尚未加载。请先授予下方权限，Helper 就绪后工具会自动出现。",
  ...
  "cuaPermission.modal.relaunchAppButton": "重启 My_ZCode",
  "cuaPermission.modal.relaunchAppHint":
    "重启 Helper 后仍未生效？重启 My_ZCode 可彻底重载 Helper 进程。",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "检测到电脑控制工具，但它们并非来自已校验的 My_ZCode 官方插件。请检查插件安装后重新验证。",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "首个会话启动时，My_ZCode 会针对该会话精确验证电脑控制工具。",
