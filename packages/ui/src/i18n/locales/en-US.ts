...
const enUS: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "How would you like My_ZCode to show its work?",
  ...
  "occupationOnboarding.memoryDescription": "Let My_ZCode remember your preferences and work context.",
  ...
  "startup.global.silent": "Starting My_ZCode",
  ...
  "startup.global.servicesFailed":
    "Local data is ready, but app services failed to start. Copy the diagnostics, then exit and reopen My_ZCode.",
  ...
  "startup.global.starting_services": "Starting My_ZCode",
  "startup.global.ready": "Local data is ready",
  "startup.global.failed": "Startup preparation failed",
  "startup.global.help":
    "My_ZCode will open when preparation finishes. Large histories may take longer. Please keep the app running.",
  ...
  "startup.global.error.lock_timeout":
    "Waiting for the database write lock timed out. Another My_ZCode or CLI process may be updating data. Retry after it finishes.",
  ...
  "startup.global.error.startup_status_timeout":
    "No startup status was received. Exit and reopen My_ZCode. If it fails again, provide the diagnostics to support.",
  "startup.global.error.transport_closed":
    "The preparation process exited or disconnected. Exit and reopen My_ZCode to check the migration records again.",
  "startup.global.error.unsupported_runtime":
    "The configured Agent does not support storage preparation. Restore the bundled Agent, then reopen My_ZCode.",
  ...
  "settings.computerUse.disabledToast":
    "Computer Use is disabled. Existing conversations require a My_ZCode restart to take effect.",
  ...
  // Welcome / Login
  "welcome.title": "Welcome to My_ZCode",
  "welcome.username": "Username",
  "welcome.password": "Password",
  "welcome.login": "Login",
  "welcome.loggingIn": "Logging in...",
  "welcome.loginFailed": "Login failed",
  "login.title": "Welcome to My_ZCode",
  "login.description": "Connect your account to start using My_ZCode",
  ...
  "logout.confirm.title": "Disconnect and restart My_ZCode?",
  ...
  "modelTrajectory.empty": "No model calls recorded (only My_ZCode Agent writes model-io)",
  ...
  "titleBar.menu.help.about": "About My_ZCode",
  ...
  "titleBar.menu.help.toggleMy_ZCodeStdioTap": "Capture agent stdio traffic",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "The workspace directory does not exist or cannot be accessed. You can only view history for now. Restore the directory and restart My_ZCode to continue.",
  ...
  "ssh.assetInstallModeDescription":
    "Remote server download reduces upload waiting, but the server must reach the My_ZCode CDN and have download, extract, and checksum tools.",
  ...
  "chat.changeSummary.rewindDialog.description":
    "My_ZCode checks current file content again before writing. If another process changed a file, no files will be written.",
  ...
  "settings.terminalFontFamilyDescription":
    "Leave blank to auto-detect system terminal settings; set a value to override the My_ZCode terminal font.",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "While My_ZCode is running, add follow-up actions to the queue or guide them to run after the next tool call.",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "The data directory cannot be the My_ZCode installation folder on Windows. Choose a folder outside the app install location.",
  ...
  "settings.migration.sectionDescription":
    "Scan native Claude Code history on this machine, optionally filter by workspace and activity window, then import the selected sessions into their matching My_ZCode task lists.",
  ...
  "resourceManager.storage.summaryTotal": "Total used by My_ZCode",
  ...
  "resourceManager.storage.diskUsage": "My_ZCode uses {used}",
  ...
  "settings.browser.desktopOnly": "Browser data can only be managed in the My_ZCode desktop app.",
  ...
  "settings.browser.import.helperVerificationFailed":
    "My_ZCode could not verify its Windows secure import component. Reinstall or update My_ZCode before importing cookies.",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome protects cookies with App-Bound encryption on Windows. For this import only, My_ZCode will request administrator access, start a temporary system service, and delete it immediately afterward. Chrome passwords are never read or imported.",
  ...
  "settings.mcp.description": "Manage MCP server configurations used by My_ZCode Agent.",
  ...
  "settings.mcp.host.activeDescription":
    "My_ZCode provides this MCP server for the {pluginName} plugin. Its runtime identity is managed by the host.",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "This My_ZCode Agent cannot refresh OAuth status. Upgrade or restart My_ZCode, then reopen MCP settings to run a full refresh.",
  ...
  "settings.mcp.failure.not_authenticated":
    "You are not signed in. Sign in to My_ZCode to use this MCP server.",
  ...
  "settings.mcpServers.import.importing": "Importing MCP servers into My_ZCode",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description":
    "Timing starts after signing in to My_ZCode 3.x.",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "Supports BYOK and BYOA. Base URL, API format, and API Key are maintained by My_ZCode automatically.",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "Add yourself or other members on the BigModel team plan management page. Once assigned, the team quota will be available in My_ZCode.",
  ...
  "settings.modelProvider.help.contextWindow":
    "The context capacity the model can process at once, in tokens. My_ZCode uses this to manage context.\nDo not exceed the model's actual limit.",
  ...
  "settings.usage.billingBanner.description":
    "Connect your {provider} account to query Coding Plan entitlement, then keep coding in My_ZCode after purchase or setup.",
  ...
  "settings.usage.entitlementServerMcpUsage": "My_ZCode MCP",
  ...
  "sidebar.usage.plan.mcp": "My_ZCode MCP",
  "sidebar.usage.plan.zcodeMcp": "My_ZCode MCP",
  "sidebar.usage.plan.zcodeMcpDescription": "Daily aggregate quota for My_ZCode built-in plugin MCPs",
  ...
  "settings.skills.import.mode.copy.description":
    "Copy the full skill directory into My_ZCode. Later changes in the external agent directory will not sync automatically.",
  "settings.skills.import.mode.symlink.description":
    "Create a directory link to the external agent skill. My_ZCode follows later source changes, but the skill depends on that source path remaining available.",
  "settings.skills.import.importing": "Importing skills into My_ZCode",
  ...
  "settings.subagents.description":
    "Manage user-level subagent Markdown files consumed by My_ZCode Agent.",
  ...
  "settings.plugins.store.subtitle":
    "Extend My_ZCode with skills, commands, and MCP servers from plugins",
  ...
  "settings.plugins.import.mode.copy.description":
    "Copy the full plugin directory into My_ZCode and register it in plugins.dirs. Later changes in the external agent directory will not sync automatically.",
  "settings.plugins.import.mode.symlink.description":
    "Create a directory link to the external agent plugin and register it in plugins.dirs. My_ZCode follows later source changes, but the plugin depends on that source path remaining available.",
  "settings.plugins.import.importing": "Importing plugins into My_ZCode",
  ...
  "settings.commands.description":
    "Manage My_ZCode Agent .md command files. Commands can be invoked with /command-name in chat.",
  "settings.commands.sourceFilterLabel": "Source filter",
  "settings.commands.source.zcodeAgent": "My_ZCode Agent",
  ...
  "settings.commands.import.mode.copy.description":
    "Copy the command file into My_ZCode. Later changes in the external agent file will not sync automatically.",
  "settings.commands.import.mode.symlink.description":
    "Create a file link to the external agent command. My_ZCode follows later source changes, but the command depends on that source path remaining available.",
  "settings.commands.import.importing": "Importing commands into My_ZCode",
  ...
  "settingsSync.action.finish": "Start using My_ZCode",
  "settingsSync.agent.zcode": "My_ZCode Agent",
  ...
  "settingsSync.discovery.helper":
    "Only missing items will be imported and your current My_ZCode settings will not be overwritten.",
  ...
  "onboarding.dialog.title": "Welcome to My_ZCode",
  ...
  "onboarding.welcome.title": "Welcome to My_ZCode",
  "onboarding.welcome.start": "Start My_ZCode",
  ...
  "onboarding.stepDescription.migration":
    "Start migration and wait while My_ZCode imports your selections.",
  ...
  "onboarding.agentsFile.confirmDescription":
    "My_ZCode will copy {source} to {target}.\nIf the target file already exists, the My_ZCode default AGENTS configuration will be overwritten.",
  ...
  "chat.placeholder.newTask":
    "Ask My_ZCode anything, @ to add context, / for commands or capabilities",
  "chat.placeholder.newTaskMobile": "Ask My_ZCode anything…",
  ...
  "chat.modelSwitch.contextWindowGuard.description":
    "This conversation has used {used} tokens, which exceeds {modelName}'s available context of {target} tokens after reserving maximum output.\nCompress the current conversation with the current model first. If the compressed context fits, My_ZCode will continue switching models.",
  ...
  "chat.toolbar.computerUse.tooltip.ready":
    "Computer Use ready — just describe what you want My_ZCode to do",
  ...
  "chat.toolbar.computerUse.tooltip.error":
    "Computer Use enablement failed. Please restart My_ZCode app and retry, or ask My_ZCode to investigate the logs",
  ...
  "workflows.hub.empty.hint":
    "Design a workflow with My_ZCode in chat, then have it save the workflow to a project once it works. Projects that aren't open don't appear here.",
  ...
  "workflows.hub.detail.whenToUse.help":
    "A routing hint for My_ZCode: when this workflow is the right pick.",
  ...
  "workflows.hub.detail.script.note":
    "The script is read-only. To change it, revise it with My_ZCode in chat and save a new version.",
  ...
  "chat.slash.emptyUnavailable":
    "No slash commands have been broadcast for the current My_ZCode Agent session",
  ...
  "chat.quota.mcp.quotaExhausted":
    'My_ZCode MCP "{server}" has used up today\'s quota. It resets tomorrow.',
  "chat.quota.mcp.codingPlanRequired":
    'No My_ZCode MCP "{server}" quota. Sign in or get a Coding Plan to use it.',
  ...
  "resourceManager.appUsage": "My_ZCode",
  ...
  "feedback.submit.template.section.copyErrorHeading": "My_ZCode Error Info",
  // Forms
  ...
  "offPeak.keepAwakeBanner": "Keep your computer awake while My_ZCode is running a chat.",
  ...
  "offPeak.form.instructionsPlaceholder":
    "Describe a task My_ZCode can work on in the background, including the expected result and any constraints…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "My_ZCode Computer Use is still preparing — its tools aren't loaded yet ({count} loaded). Grant the permissions below; tools appear once the helper is ready.",
  "chat.cuaReadiness.toolsPreparing":
    "My_ZCode Computer Use is still preparing — its tools aren't loaded yet. Grant the permissions below; tools appear once the helper is ready.",
  ...
  "cuaPermission.modal.relaunchAppButton": "Restart My_ZCode",
  "cuaPermission.modal.relaunchAppHint":
    "Still not working after restarting Helper? Restart My_ZCode to fully reload the Helper process.",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "Computer Use tools were found, but they did not come from the verified My_ZCode plugin. Review the plugin installation, then check again.",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "My_ZCode will verify the Computer Use tools against the exact session when your first session starts.",
